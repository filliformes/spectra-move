...
static int get_param(void *instance, const char *key, char *buf, int buf_len) {
    ...
    if (strcmp(key, "chain_params") == 0) {
        return snprintf(buf, buf_len,
            ...
            "{\"key\":\"chord_drift\",\"short_name\":\"DRIFT\",\"name\":\"Chord Drift\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"resonators\",\"name\":\"Resonators\",\"type\":\"enum\",\"options\":[\"5\",\"7\",\"12\"]},"
            "{\"key\":\"polyphony\",\"name\":\"Polyphony\",\"type\":\"enum\",\"options\":[\"1\",\"2\",\"4\"]},"
            "{\"key\":\"octave_range\",\"short_name\":\"OCTRNG\",\"name\":\"Oct Range\",\"type\":\"enum\",\"options\":[\"1\",\"2\",\"3\",\"4\"]},"
            "{\"key\":\"pre_gain\",\"short_name\":\"PRE GN\",\"name\":\"Pre Gain\",\"type\":\"float\",\"min\":-12,\"max\":12,\"step\":0.5},"
            "{\"key\":\"post_gain\",\"short_name\":\"PO GN\",\"name\":\"Post Gain\",\"type\":\"float\",\"min\":-12,\"max\":12,\"step\":0.5},"
            ...
            "{\"key\":\"arp_rate\",\"short_name\":\"Arp\",\"name\":\"Arp Rate\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"arp_pattern\",\"short_name\":\"Ptrn\",\"name\":\"Arp Ptrn\",\"type\":\"enum\",\"options\":[\"Off\",\"Up\",\"Down\",\"Random\",\"Chord\"]},"
            "{\"key\":\"arp_sync\",\"short_name\":\"Sync\",\"name\":\"Arp Sync\",\"type\":\"enum\",\"options\":[\"Free\",\"Sync\"]},"
            "{\"key\":\"drift\",\"name\":\"Drift\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"motion_rate\",\"short_name\":\"Rate\",\"name\":\"Mot Rate\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"motion_depth\",\"short_name\":\"Depth\",\"name\":\"Mot Depth\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"motion_shape\",\"short_name\":\"Shape\",\"name\":\"Mot Shape\",\"type\":\"enum\",\"options\":[\"Sine\",\"Triangle\",\"Square\",\"S&H\"]},"
            ...
            "{\"key\":\"rnd_spectra\",\"short_name\":\"Spectra\",\"name\":\"Rnd Spectra\",\"type\":\"int\",\"min\":0,\"max\":1,\"step\":1},"
            "{\"key\":\"rnd_motion\",\"short_name\":\"Motion\",\"name\":\"Rnd Motion\",\"type\":\"int\",\"min\":0,\"max\":1,\"step\":1},"
            "{\"key\":\"rnd_pan\",\"short_name\":\"Pan\",\"name\":\"Rnd Pan\",\"type\":\"int\",\"min\":0,\"max\":1,\"step\":1},"
